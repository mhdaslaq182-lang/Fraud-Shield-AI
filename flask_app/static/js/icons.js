...
const ICONS = {
    ...
    register: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M16 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2"/><circle cx="8.5" cy="7" r="4"/><line x1="20" y1="8" x2="20" y2="14"/><line x1="23" y1="11" x2="17" y2="11"/></svg>',
    ...
    brain:    '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M9.5 2A2.5 2.5 0 017 4.5A2.5 2.5 0 014.5 7A2.5 2.5 0 012 9.5v5A2.5 2.5 0 004.5 17A2.5 2.5 0 007 19.5A2.5 2.5 0 009.5 22h5a2.5 2.5 0 002.5-2.5a2.5 2.5 0 002.5-2.5a2.5 2.5 0 002.5-2.5v-5A2.5 2.5 0 0019.5 7A2.5 2.5 0 0017 4.5A2.5 2.5 0 0014.5 2z"/></svg>',
    ...
    docker:   '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="8" width="4" height="4"/><rect x="7" y="8" width="4" height="4"/><rect x="12" y="8" width="4" height="4"/><rect x="7" y="3" width="4" height="4"/><rect x="12" y="3" width="4" height="4"/><path d="M22 12c0 0-1-1-4-1s-5 2-8 2-4-1-4-1"/></svg>',
    python:   '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><path d="M8 12h8M12 8v8"/></svg>',
};

function icon(name, size=18, color='currentColor') {
    const svg = ICONS[name];
    if (!svg) return '';
    return svg.replace('<svg', '<svg width="'+size+'" height="'+size+'" style="color:'+color+';display:inline-block;vertical-align:middle"');
}
